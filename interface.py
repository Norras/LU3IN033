...
class App:
    ...
    def __init__(self):
        ...
        self.openbutton=Button(self.window, text="Ouvrir un fichier", command=self.openFile)
        self.openbutton.grid(row=1, column=1,sticky="nsew", padx=5, pady=5, ipadx=5, ipady=5, columnspan=2, rowspan=2)
        self.window.config(background="#DFCFBE")
